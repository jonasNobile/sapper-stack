...
The [Sapper](https://github.com/sveltejs/sapper) template, with SCSS support for Rollup.
...
You can deploy your application to any environment that supports Node 10 or above. As an example, to deploy to [Vercel](https://vercel.com) when using `sapper export`, run these commands:
